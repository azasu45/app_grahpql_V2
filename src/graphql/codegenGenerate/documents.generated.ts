...
export type PagosRecibidosQuery = { __typename?: 'Query', misPagos: Array<{ __typename?: 'Pago', id: string, captureImg: string, estado: number, monto: any, fecha: any, cobro: { __typename?: 'Cobro', id: string } }> };
