  ...
  return (
    <Menu
      ...
      <div className='z-50 absolute cursor-pointer left-0 top-0 h-[4rem] w-[4rem] -translate-x-2 -translate-y-2 rounded-full border-[5px] border-gray-50 dark:border-gerenal-principal'>
        <div
          className={classNames(
            ...
            'absolute inset-0 overflow-hidden rounded-[50%] bg-slate-600 cursor-pointer'
          )}>
          {
            <>
      ...
      <Transition
        ...
        <Menu.Items className='absolute right-0 mt-8 w-full z-[1000] bg-white origin-top-right ring-1 ring-opacity-5 rounded-md whitespace-break-spaces'>
