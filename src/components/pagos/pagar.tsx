...
import { Button, Card, Col, Flex, Grid, Text, TextInput, NumberInput } from '@tremor/react';
        ...
        .then(async (result) => {
          if (result.isConfirmed) {
            ...
            mutation({
              ...
              refetchQueries: ['misPagosRealizados'],
              onCompleted: (data) => {
                sweetAlert.fire({
                  icon: 'success',
                  timer: 10000,
      ...
      <form onSubmit={onSubmit}>
        ...
        <Card
          className={classNames(
            abrirBuscarUsuario ? 'hidden' : '',
            'mt-2 mx-auto min-w-[18rem] max-w-md'
          )}>
